    ...
    <div class="row">
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="<?= base_url('admin/dokter/update/' . $encryptedID) ?>" method="POST" enctype="multipart/form-data">
                        <?= csrf_field() ?>
                        <!-- Nama dan Email -->
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control <?= (session()->has('errors') && isset(session('errors')['place_of_birth'])) ? 'is-invalid' : '' ?>" id="place_of_birth" name="place_of_birth" value="<?= old('place_of_birth', $doctor['place_of_birth']) ?>" placeholder="Masukkan tempat lahir">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control <?= (session()->has('errors') && isset(session('errors')['phone'])) ? 'is-invalid' : '' ?>" id="phone" name="phone" value="<?= old('phone', $doctor['phone']) ?>" placeholder="Masukkan nomor telepon">
                        ...
                        <div class="form-group">
                            ...
                            <?php if ($doctor['photo']): ?>
                                <div class="mb-2">
                                    <img src="<?= base_url('uploads/photos/' . $doctor['photo']) ?>" alt="Current Photo" class="img-thumbnail" style="max-height: 200px">
                                </div>
                            <?php endif; ?>
                            <input type="file"
