                                            ...
                                            <td class="pe-4 text-center position-relative">
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton<?= esc($mhs['coass_id']) ?>">
                                                        ...
                                                        <?php endif; ?>
                                                        <li>
                                                            <a class="dropdown-item d-flex align-items-center" href="<?= base_url("admin/penilaian/detail-penilaian/detail-nilai-mahasiswa/$encryptedID/{$mhs['encrypted_coass_id']}") ?>">
