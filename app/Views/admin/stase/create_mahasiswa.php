        ...
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="<?= base_url('admin/stase/detail-stase/store') ?>" method="POST">
                        <?= csrf_field(); ?>
                        ...
                        <a href="<?= base_url('admin/stase/detail-stase/' . $encryptedID) ?>" class="btn bg-gradient-info">Kembali</a>
                    </form>
                </div>
            </div>
        </div>
