        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                    ...
                    <a class="btn bg-gradient-success" href="<?= base_url('admin/stase/detail-stase/tambah-mahasiswa/' . $encryptedID) ?>">
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    ...
                    <!-- Search Form -->
                    <div class="px-4 pt-3">
                        <form action="<?= base_url('admin/stase/detail-stase/' . $encryptedID) ?>" method="GET" class="mb-3">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content bg-white">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form action="<?= base_url('admin/stase/detail-stase/delete-mahasiswa') ?>" method="post">
                                                            <?= csrf_field() ?>
