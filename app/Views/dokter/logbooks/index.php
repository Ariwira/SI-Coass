        ...
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    ...
                    <!-- Search Form -->
                    <div class="px-4 pt-3">
                        <form action="<?= base_url('dokter/logbook') ?>" method="GET" class="mb-3">
                            <div class="position-relative">
                                ...
                                <?php if (!empty($keyword)): ?>
                                    <a href="<?= base_url('dokter/logbook') ?>"
                                    ...
                                    <?php foreach ($students as $student): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center pe-4">
                                                <a class="text-secondary fw-bold text-sm" href="<?= base_url('dokter/logbook/detail-logbook/' . esc($encryptedID)) ?>">
